package kr.co.ticatcher.member.service.impl;

import kr.co.ticatcher.api.member.service.MemberService;
import kr.co.ticatcher.dao.MemberDAO;
...
public class MemberServiceImpl implements MemberService {
	...
	public String sendSMS(String to) {
		...
		String api_secret = "XH3PTLHXSITLZSBK7TYXWHW4GKOQA9DU";
	...
	@Transactional
	@Override
	public int deleteMembers(List<String> checkedIdList) throws Exception {
	    int result = 0;
	    result += mdao.deleteMembers(checkedIdList);
	    return result; 
	}

	@Override
	public int resetPwd(String mem_id) {
		return mdao.resetPwd(mem_id);
	}

	@Override
	public int restore(List<String> checkedIdList) {
		return mdao.restore(checkedIdList);
	}

...
public class AdminController {
	...
	public String manageStage(HttpSession session, Model model, String cpg, String searchType, String keyword){
		String returnPage = "redirect:/admin";
		if(session.getAttribute("admin") != null){
			int perPage = 10;
			if (cpg == null || cpg.equals("")) cpg = "1";
			...
			model.addAttribute("pages",asrv.readCountStage(param));
			model.addAttribute("stageList", asrv.readStage(param));
	...
	@GetMapping("/manageDeleteMember")
	public String manageDeleteMember(HttpSession session, Model model, String cpg){
		String returnPage = "redirect:/admin";
		if(session.getAttribute("admin") != null){
			int perPage = 10;
			if (cpg == null || cpg.equals("")) cpg = "1";
			...
			model.addAttribute("pages", asrv.readCountDeleteMember());
			model.addAttribute("memberList", asrv.readDeleteMember(snum));
			model.addAttribute("stpgn", stpgn);

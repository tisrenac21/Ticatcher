package kr.co.ticatcher.api.member.service;
...
//    boolean checkLogin(MemberVO mvo);
	...
	int deleteMembers(List<String> checkedIdList) throws Exception;
	int resetPwd(String mem_id);
	int restore(List<String> checkedIdList);
}
